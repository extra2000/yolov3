...
class DatasetGenerator(object):
    ...
    def __init__(self, config, dataset_type):
        ...
        if dataset_type == 'train':
            self.annot_path  = config['yolov3']['training']['annot_path']
            self.input_sizes = config['yolov3']['training']['input_size']
            self.batch_size  = config['yolov3']['training']['batch_size']
            self.data_aug    = config['yolov3']['training']['data_aug']
        elif dataset_type == 'test':
            self.annot_path  = config['yolov3']['testing']['annot_path']
            self.input_sizes = config['yolov3']['testing']['input_size']
            self.batch_size  = config['yolov3']['testing']['batch_size']
            self.data_aug    = config['yolov3']['testing']['data_aug']
        else:
            raise ValueError(dataset_type)

        self.train_input_sizes = np.array(config['yolov3']['training']['input_size'])
        self.strides = np.array(config['yolov3']['strides'])
        self.classes = read_class_names(config['yolov3']['classnames'])
        self.num_classes = len(self.classes)
        self.anchors = np.array(config['yolov3']['anchors']['baseline'])
